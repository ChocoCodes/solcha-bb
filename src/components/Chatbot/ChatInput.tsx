    ...
    return (
        <div className="mx-auto lg:w-7/10 lg:pb-10 w-9/10 pt-1 pb-2 flex flex-col gap-4 bg-transparent">
            <h1 className="p-2 bg-transparent text-white w-4/5 mx-auto text-xs md:text-lg text-center lg:w-full">
                BB Bot <span className="underline text-bold">CANNOT</span> predict nor forecast data. Live data is provided by <span className="underline text-white"><a className="text-white" href='https://wovodat.phivolcs.dost.gov.ph/' target="_blank">DOST-PHIVOLCS</a></span>.
            </h1>
